...
from Devine.utils import devineBin, get_channeplayCB, seconds_to_min
...
@app.on_callback_query(filters.regex("GetTimer") & ~filter)
...
@app.on_callback_query(filters.regex("GetQueued") & ~filter)
@languageCB
...
@app.on_callback_query(filters.regex("queue_back_timer") & ~filter)
@languageCB
